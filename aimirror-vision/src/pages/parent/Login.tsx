    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted p-4">
      <Card className="w-full max-w-md glass-effect shadow-card">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">تسجيل الدخول - ولي الأمر</CardTitle>
          <CardDescription>سجل دخولك لمتابعة أطفالك</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username">اسم المستخدم أو البريد الإلكتروني أو رقم الهاتف</Label>
              <Input
                id="username"
                type="text"
